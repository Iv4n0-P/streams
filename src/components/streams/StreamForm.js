...
class StreamForm extends React.Component {
    ...
    onSubmit = (formValues, history) => { //ne primamo ni event objekt sad kad radimo sa redux form, sve on rješava za nas, nego primamo koje god vrijednosti se submitaju, koje ćemo nazvat npr. formValues
        //e.preventDefault()
        //ne treba preventatDefaultno jer to sad redux form radi za nas
        this.props.onFormSubmit(formValues, history) //okidamo action kreatora kojeg smo importirali i povezali u connect i prosljeđujemo vrijednosti forme
...
export default reduxForm({//redux form će kroz propse komponenti poslat tonu propsa, među njima je i handleSumbit, redux form metoda za submitanje
    //prosljeđujemo joj konfiguracijski objekat
    form: 'streamForm', //neko ime, nebitno, samo da zna pod čim će nas zapisat u state, pod kojim imenom
    validate
})(StreamForm) //dakle reduxForm će vratit funkciju i odmah zovemo tu funkciju i prosljeđujemo joj StreamCreate


//CONNECT I REDUX-FORM ZAJEDNO
/* 
